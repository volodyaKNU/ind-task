...
const cardData: BentoCardProps[] = [
  {
    ...
    title: "Development projects launched annually",
    results: "45",
  ...
  },
  {
    ...
    title: "Public services delivered this year",
    results: "850+",
  ...
  },
  {
    ...
    results: "12,584",
    description: "Total residents in our thriving village",
  },
  {
    color: "#FFFFFF0D",
    label: "Digital Innovation",
    title: "Online requests processed monthly",
    results: "2,340",
    description: "Digital Requests",
  },
  {
    color: "#FFFFFF0D",
    label: "Satisfaction Rate",
    title: "Residents satisfied with our services",
    results: "98%",
...

  {
    color: "#FFFFFF0D",
    label: "Response Time",
    title: "Average time to handle citizen requests",
    results: "24",
            ...
            if (enableStars) {
              return (
                ...
                >
                  ...
                  <div className="text-center !text-5xl font-semibold text-[#d468fb]">
                    {card.results}
                  </div>
                  <div className="card__content flex flex-col relative text-white">
                    <h3
                      className={`card__title font-normal text-sm m-0 mb-1 ${
